...
-- =========================
-- PERFORMANCE_CAST_COMMON / PERFORMANCE_CAST_ROUND (공연 캐스팅) — PER02_DETAIL01 공연 상세 조회용
-- (구 PERFORMANCE_CAST 단일 테이블에서 정규화를 위해 분리됨 — performance_id/round_id의
--  조건부 중복을 없애기 위해 "전체 회차 공통"과 "회차 전용"을 각각 별도 테이블로 관리)
--
